...
[Icons]
Name: "{group}\RelatorioFiscal"; Filename: "{app}\RelatorioFiscal 2.exe"; WorkingDir: "{app}"
...
[Run]
Filename: "{app}\RelatorioFiscal 2.exe"; Description: "Executar após instalar"; Flags: nowait postinstall skipifsilent
